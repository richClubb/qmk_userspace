 ...
 */
 [_HALMAK] = LAYOUT_elora_hlc(
    ...
    TD(TD_LSFT_CAPS) ,  KC_F ,    KC_M ,   KC_V ,    KC_C , KC_SLSH , KC_LBRC , KC_CAPS ,     FKEYS , KC_RBRC ,   KC_G ,    KC_P ,   KC_X ,  KC_K ,  KC_Y , TD(TD_RSFT_CAPS) ,
 ...
 */
    [_ADJUST] = LAYOUT_elora_hlc(
      ...
      _______, _______, _______, QWERTY , HALMAK , _______,                                    _______, _______, _______, _______,  _______, _______,
